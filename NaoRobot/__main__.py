...
PM_START_TEXT = """
[✨](https://telegra.ph/file/9c6e5b30022565cbe9f4a.jpg) ʜᴇʟʟᴏ ɪ ᴀᴍ ᴀ ʙᴏᴛ ᴍᴀɴᴀɢᴇʀ
ᴡʜᴏ ᴡɪʟʟ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ [oscar​](https://t.me/GwMuluAjg) 
"""
...
nao_IMG = "https://telegra.ph/file/89a3c8ffa4283178e99a8.jpg"
    ...
    if query.data == "nao_":
        query.message.edit_text(
            text=""" 💡 I'm *OSCAR ROBOT*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about OSCAR ROBOT, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Source", url="https://github.com/oscarprojek/OSCAR-ROBOT"
                    ),
                    InlineKeyboardButton(text="Dev", url="https://t.me/GwMuluAjg")
                 ],
                 [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi I'm *OSCAR ROBOT*
                 \nHere is the [Source Code](https://github.com/oscarprojek/OSCAR-ROBOT) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
